...
if($_SERVER['REQUEST_METHOD'] == "POST" ){
    ...
    $longitude = $_POST['longitude']; //經度
    $latitude = $_POST['latitude']; //緯度
    ...
    $stmt = $conn->prepare("INSERT INTO android_accident_record (account, image_path, map_location, map_longitude, map_latitude) VALUES (?, ?, ?, ?, ?);");
    $stmt->bind_param("sssss", $account, $image_path, $location, $longitude, $latitude);
    $stmt->execute();
}
?>